...
| **Status** | The current application status displayed as a colour-coded badge (e.g. `Pending`). See [Application Statuses](/guides/credit-applications#application-statuses). |
...
| Button | Description |
|---|---|
| **Edit** | Opens the [Edit Credit Application](/guides/edit-credit-application) form to modify and rescore the application. |
